...
export default function Header({ ...props }) {
    return (
        <header class="w-screen bg-base-200/30 px-4 z-50 before:absolute before:left-0 before:size-full before:backdrop-blur-md h-16 rounded-b-full sm:h-16 lg:h-20 lg:ps-5 fixed top-0 left-0 shadow-lg" id="mh-header">
