            ...
            <div class="">
                <nav class="dropdown max-lg:fixed max-lg:bg-transparent max-lg:left-2 z-50 max-lg:top-2 max-lg:aspect-square max-lg:float-left  bg-base-100 rounded-box">
                    ...
                    <ul tabIndex="0" class="menu max-lg:dropdown-content lg:w-full flex-nowrap overflow-x-auto max-lg:mt-2  max-h-[60vh] lg:menu-horizontal  max-lg:flex-col bg-base-100 flex justify-around gap-2 p-2 rounded-box">
                        <li class="active">
                            <a class="text-base-content" href="#home">Home</a>
                        </li>
                        <li>
                            <a class="text-base-content" href="#about">About</a>
                        </li>
                        <li>
                            <a class="text-base-content" href="#skills">Skills</a>
                        </li>
                        <li>
                            <a class="text-base-content" href="#experience">Experiences</a>
                        </li>
                        <li>
                            <a class="text-base-content" href="#certifications">Certifications</a>
                        </li>
                        <li>
                            <a class="text-base-content" href="#portfolio">Portfolio</a>
                        </li>
                        <li>
