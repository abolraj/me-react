        ...
        <section className="experience text-base-content" id="experience">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap my-8">
                    <div className="w-full md:w-1/2 mb-8 p-2">
                        <div className="education">
                            ...
                            <div className="education-details">
                                {educations.map((education, index) => (
                                    <div key={index} className="education-item p-6 rounded-xl shadow-2xl mb-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay={education.delay}>
                        ...
                        <div className="work">
                            ...
                            <div className="experience-details">
                                {works.map((work, index) => (
                                    <div key={index} className="work-item p-6 rounded-xl shadow-2xl mb-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay={work.delay}>
                                        ...
                                        <ul className="work-responsibility text-left list-['⭐'] list-inside ml-6">
