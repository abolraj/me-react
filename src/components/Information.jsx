            ...
            <div class="container mx-auto">
                <div class="row flex flex-wrap">
                    <div class="w-full md:w-1/2 px-4">
                        <div class="about-img shadow-lg w-96" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                            <img src={devImg} alt="Developer Image" class="img-fluid h-full" />
                        </div>
                    </div>
                    <div class="w-full md:w-1/2 px-4">
                        <div class="about-inner text-base-content text-left">
                            <h2 class="text-4xl font-bold mb-4 " data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
                                About Me &nbsp;
                                <FontAwesomeIcon icon={faInfoCircle}/>
                            </h2>
                            <p class="text-lg mb-6 aos-init aos-animate" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                            ...
                            <div class="about-tag flex flex-wrap gap-2 mb-6 " data-aos="fade-up" data-aos-duration="800" data-aos-delay="300">
